...
constexpr int HNSW_DEFAULT_EF_CONSTRUCTION = 600;
constexpr int HNSW_DEFAULT_EF_SEARCH = 600;
...
extern "C" {
    ...
    void get_hnsw_params(int* M, int* ML, int* EFC, int* EFS, int* build_threads);
}
