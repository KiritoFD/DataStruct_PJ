...
class solution {
public:
    solution(const std::string& metric = "l2", int num_centroid = 1024, int kmean_iter = 16, int nprob = 256);
...
class Solution {
public:
    Solution(int num_centroid = 1024, int kmean_iter = 16, int nprob = 256);
